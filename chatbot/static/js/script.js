document.addEventListener('DOMContentLoaded', function () {
    ...
    chatMessages.addEventListener('click', function (event) {
        ...
        if (target.classList.contains('question-button')) {
            const selectedQuestion = target.textContent; // or use target.innerText
    ...
    function formatGenieResponses(responses) {
        ...
        const formattedResponses = responses.map(response => `<button class="question-button">${response}</button>`).join(' ');
